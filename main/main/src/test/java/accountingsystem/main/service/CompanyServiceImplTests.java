...
public class CompanyServiceImplTests {
    ...
    public void findByNameLikeTest2() {
        ...
        Company company1 = new Company(user1.getFirstName(), "TestUser", "Karposh3", LocalDateTime.now(), "XYZ2", "993-3322", user1);

        User user2 = new User("testUsername2", "testPassword2", "TestName2", "TestLastname2");
        Company company2 = new Company(user2.getFirstName(), "TestUser", "Karposh3", LocalDateTime.now(), "XYZ3", "993-3323", user2);
    ...
    public void findByUserTest() {
        ...
        Company company = new Company("Apple", "Steve Jobs", "Atinska", LocalDateTime.now(), "XYZ", "993-332", user);
        Company company1 = new Company("Amazon.com", "Jeff Bezos", "Praska", LocalDateTime.now(), "XYZ2", "993-3322", user);
        Company company2 = new Company("BMW", "Franz Josel Popp", "Njudelhiska", LocalDateTime.now(), "XYZ3", "993-3323", user);
