...
public class TurnoverServiceImplTests {
    ...
    @InjectMocks
    TurnoverServiceImpl turnoverService;
    ...
    public void getAllTurnoversTest() {
        ...
        Turnover turnover = new Turnover(LocalDateTime.now(),100,30l,workServiceList,productList,company);

        User user2 = new User("testUsername","testPassword","TestName","TestLastname");
        Company company2 = new Company(user.getFirstName(),"TestUser","Karposh3", LocalDateTime.now(),"XYZ","993-332",user);
        ...
        Product product3 = new Product("productDescription","productName",manufacturer,150l, LocalDateTime.now(),LocalDateTime.now());
        Manufacturer manufacturer3 = new Manufacturer("TestUser","MKD");
        Product product2 = new Product("productDescription","productName",manufacturer,150l, LocalDateTime.now(),LocalDateTime.now());
        List<Product> productList1 = new ArrayList<>();
        productList.add(product3);
        productList.add(product2);
        Turnover turnover1 = new Turnover(LocalDateTime.now(),100,30l,workServiceList1,productList1,company2);


        User user3 = new User("testUsername","testPassword","TestName","TestLastname");
        Company company3 = new Company(user.getFirstName(),"TestUser","Karposh3", LocalDateTime.now(),"XYZ","993-332",user);
        ...
        Product product5 = new Product("productDescription","productName",manufacturer,150l, LocalDateTime.now(),LocalDateTime.now());
        Manufacturer manufacturer5 = new Manufacturer("TestUser","MKD");
        Product product6 = new Product("productDescription","productName",manufacturer,150l, LocalDateTime.now(),LocalDateTime.now());
        List<Product> productList3 = new ArrayList<>();
        productList.add(product5);
        productList.add(product6);
        Turnover turnover2 = new Turnover(LocalDateTime.now(),100,30l,workServiceList3,productList3,company3);
    ...
    public void createTurnoverTest() {
        ...
        //when
        when(turnoverRepository.save(any(Turnover.class)))
                .thenReturn(turnover);

        Turnover createdTurnover = turnoverService.save(turnover.getDate(),turnover.getNumberProducts(),turnover.getAmount(),turnover.getWorkServiceList(),turnover.getProductList(),turnover.getCompany());
    ...
    public void deleteTurnoverById() {
        ...
        when(turnoverRepository.findById(turnoverId)).thenReturn(java.util.Optional.of(turnover)).thenReturn(null);
...
//        productList.add(product3);
//        productList.add(product2);
//        Turnover turnover1 = new Turnover(LocalDateTime.now(),100,30l,workServiceList1,productList1,company);
//
//
//        User user3 = new User("testUsername","testPassword","TestName","TestLastname");
//        WorkService workService6 = new WorkService("testName","testDescription",150l);
...
//        productList.add(product5);
//        productList.add(product6);
//        Turnover turnover2 = new Turnover(LocalDateTime.now(),100,30l,workServiceList3,productList3,company);
//
//
//         turnovers.add(turnover);
//         turnovers.add(turnover1);
//         turnovers.add(turnover2);
//
//        Double sum = Double.valueOf(turnover.getAmount() + turnover1.getAmount()  + turnover2.getAmount());
//
//         //when
...
//
//        List<Turnover> expectedTurnovers = turnoverService.getAllByCompanyAndMonth(companyId, LocalDateTime.now());
//
//        //test
