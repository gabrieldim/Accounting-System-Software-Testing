...
//        Product product = new Product("testProduct","testName",manufacturer,50l,LocalDateTime.now(),LocalDateTime.now());
//        Product product1 = new Product("testProduct2","testName2",manufacturer,50l,LocalDateTime.now(),LocalDateTime.now());
