...
class UserPitTests {
    ...
    void getAuthorities() {
        User user = new User("testUsername", "testPassword", "TestName", "TestLastname");
        Assertions.assertEquals(user.getAuthorities().toString(), "["+Role.ROLE_USER.getAuthority().toString()+"]");
    ...
    void getAndSetCompanies() {
        ...
        Company company1 = new Company(user.getFirstName(), "TestUser", "Karposh3", LocalDateTime.now(), "XYZ", "993-332", user);
