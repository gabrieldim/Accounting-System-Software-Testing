...
class CompanyPitTests {
    ...
    void getProducts() {
        ...
        Company company = new Company(user.getFirstName(), "TestUser", products, workServices, "Karposh3", LocalDateTime.now(), "XYZ", "993-332", user);
    ...
    void getIncorporationDate() {
        ...
        Company company = new Company(user.getFirstName(), "TestUser", "Karposh3", p, "XYZ", "993-332", user);
